...
import { kConverter } from '../../lib/isConverter.js';
          ...
          {nowPlayingMovies.map((movie)=>(
            <div key={movie.id} className={`relative max-w-40 cursor-pointer group-hover:not-hover:opacity-40 hover:-translate-y-1 transition duration-300 `} onClick={()=>setSelectedMovie(movie.id)}>
              ...
              {selectedMovie===movie.id && (
                <div className='absolute top-2 right-2 flex items-center jusitfy-center bg-primary h-6 w-6 rounded'>
      ...
      <div className='mt-8 '>
        ...
        <div className='mt-6'>
          ...
          <div className='inline-flex gap-5 border border-gray-600 p-1 pl-3 rounded-lg'>
            ...
            <button onClick={handleDateTimeAdd} className='bg-primary/80 text-white px-3 py-2 text-sm rounded-lg hover:ng-primary cursor-pointer'>
              Add Time
            </button>
          </div>
        </div>
